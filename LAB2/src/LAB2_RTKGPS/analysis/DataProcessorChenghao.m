...
for i = 1:length(motion_msgStructs)
    ...
    QUAL_motion = [QUAL_motion;motion_msgStructs{i}.Quality];
end
%% Clear clutter in workspace
clear bSel fontSize i nonstatic_file nonStaticbag path static_bag static_file

%% CHANGE THESE NUMBERS!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
UTME_static2 = mod(UTME_static,328000.00);
UTMN_static2 = mod(UTMN_static,468900.00);
% QUAL_static = QUAL_static;

UTME_motion2  = mod(UTME_motion,328000.00);
UTMN_motion2  = mod(UTMN_motion,468900.00);
